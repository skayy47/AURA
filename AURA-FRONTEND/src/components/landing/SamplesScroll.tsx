...
const SAMPLES = [
  {
    ...
    rows: 620,
    cols: 13,
    nameKey: "samplesRevenueName",
    descKey: "samplesRevenueDesc",
    breakKey: "samplesRevenueBreak",
    tags: ["time-series", "revenue", "MENA"],
  },
  {
    n: "02",
    slug: "mena-workforce",
    ...
    rows: 515,
    cols: 12,
    nameKey: "samplesWorkforceName",
    descKey: "samplesWorkforceDesc",
    breakKey: "samplesWorkforceBreak",
    tags: ["people", "correlation", "MENA"],
  },
  {
    n: "03",
    ...
    rows: 500,
    cols: 11,
    nameKey: "samplesRetailName",
    descKey: "samplesRetailDesc",
    breakKey: "samplesRetailBreak",
    tags: ["messy", "cleaning", "MENA"],
  },
] as const;
